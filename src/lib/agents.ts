...
export const agents: readonly AgentListing[] = [
  ...
  { slug: "grok", name: "Grok", status: "Planned", summary: "Your relationships, in Grok.", detail: "Official Grok at grok.com. Custom connector setup is being verified; no working Mutuals connection is advertised yet.", marketplace: "No partnership or listing." },
